...
function AdminDashboardContent() {
  ...
  const categoryUnitData = useMemo(() => {
    ...
    const unitTypeCount = unitTypes
      .map((unit: any) => {
        const count = products.filter(
          (p: any) => p.unitType?._id === unit._id
        ).length;
      ...
      <div className="p-4 md:p-8 space-y-6 md:space-y-8">
        ...
        <div>
          ...
          <p className="text-sm md:text-base text-muted-foreground">
            System overview and statistics for administration of the application and users. 
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            {statCards.map((stat) => (
              ...
              >
                ...
                <p className="text-2xl md:text-2xl font-semibold text-foreground">
                  {stat.value}
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-4">
          ...
          <div className="bg-card border border-border rounded-lg p-4 md:p-6">
            <div className="mb-4">
              <h3 className="font-semibold text-foreground">
                Categories & Unit Types Usage
              </h3>
              <p className="text-xs text-muted-foreground mt-1">
                Top 5 categories and unit types by product count
              </p>
            </div>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {statistics?.activity?.movementsByType ? (
                <div className="space-y-3">
                  {Object.entries(statistics.activity.movementsByType).map(
                    ([type, count]) => (
                      <div
                        key={type}
                        className="flex items-center justify-between py-2 border-b border-border last:border-0"
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  {statistics.products.lowStock} products are running low on
                  stock.
                  <Link
                    href="/admin/products"
